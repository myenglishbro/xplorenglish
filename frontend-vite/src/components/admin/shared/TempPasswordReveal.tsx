 ...
 * de esta prop, que a su vez viene del valor de retorno en memoria de la mutación que la generó).
 * Usado tanto al crear un estudiante como al regenerar su contraseña.
 */
