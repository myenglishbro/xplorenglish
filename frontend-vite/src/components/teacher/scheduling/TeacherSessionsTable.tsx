...
export interface TeacherSessionsTableProps {
  ...
  /** Próximas: puede iniciar/finalizar. Pasadas: solo lectura.
   * NOTA (Fase 2): "Reprogramar" (RescheduleSessionButton) queda deferido -- no portado todavía,
   * a propósito, por alcance/tiempo de esta migración. */
  showActions: boolean;
}

export function TeacherSessionsTable({ sessions, showActions }: TeacherSessionsTableProps) {
