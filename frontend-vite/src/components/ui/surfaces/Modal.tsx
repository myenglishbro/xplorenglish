    ...
    >
      <div
        ...
        style={{
          width: "100%",
          maxWidth: width,
          maxHeight: "calc(100vh - min(48px, 8vw))",
          display: "flex",
          ...
          overflow: "hidden",
          animation: "xp-pop var(--duration-base) var(--ease-standard)",
          ...style,
        }}
      >
        <div style={{ display: "flex", alignItems: "flex-start", gap: 16, padding: "22px 24px 0", flex: "0 0 auto" }}>
        ...
        <div style={{ padding: "20px 24px", overflowY: "auto", minHeight: 0 }}>{children}</div>
        {footer && (
          <div style={{ display: "flex", flexWrap: "wrap", justifyContent: "flex-end", gap: 10, padding: "16px 24px", borderTop: "1px solid var(--border-subtle)", background: "var(--surface-sunken)", flex: "0 0 auto" }}>
            {footer}
          </div>
        )}
      </div>
