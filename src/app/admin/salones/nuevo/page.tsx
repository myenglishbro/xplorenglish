...
import { CreateClassroomForm } from "@/components/admin/classrooms/CreateClassroomForm";

export default async function AdminNewClassroomPage() {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: "var(--space-5)" }}>
      ...
      <Card>
        <CreateClassroomForm programs={programs} />
      </Card>
    </div>
  );
}
