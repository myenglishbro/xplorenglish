...
/**
 * Client Component: las columnas de DataTable llevan funciones `render`, que un Server Component
 * (AttendanceSection) no puede pasarle a un Client Component (DataTable) -- de ahí que esta tabla
 * viva acá, recibiendo solo datos planos (roster, sessionId, suggestedMinutes) y construyendo sus
 * propias columnas localmente en vez de recibirlas por props.
 */
